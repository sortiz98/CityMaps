...
/**
 * This MapServer class is the entry point for running the JavaSpark web server for the CityMaps
...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        return graph.getLocationsByPrefixHelper(prefix);
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        return graph.getLocationsHelper(locationName);
    }
